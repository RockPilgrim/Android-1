...
public class WorkoutDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        workout = workoutList.getWorkout((Integer) getIntent().getExtras().getSerializable(TagContainer.HOLDER_DETAIL_INTENT_TAG));

//        workout = new Workout(String.valueOf(getIntent().getExtras().getSerializable(TagContainer.HOLDER_DETAIL_INTENT_TAG)),1);
        initGUI();
    ...
    private void checkRecord(String w, String reps) {
        try {
            ...
            if (weightNew >= weightOld && repsNew >= repsOld) {
                ...
                workoutList.addWorkout(workout.getIndex(),workout);
            }
